...
网站刚建成那会儿，写过一篇建站后感 *[Jekyll到底是什么？](https://lu3xiang.top/jekyll/github/2016/11/08/what-is-Jekyll.html)*，文章部分涉及如何利用Jekyll搭建个人博客，但主要还是抒发建站感想的。而现在这篇文章，则是完全围绕如何建站，希望按照这篇文章能够原样创建一个博客网站。
